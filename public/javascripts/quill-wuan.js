...
var Quill = function () {
    _createClass(Quill, null, [{
        ...
        /**
         * @constructs Quill
         * @param  {String} container quill容器的选择器
     ...
     * @param {DOM object} refNode   插入这个元素之前
     */
    ...
    _createClass(Quill, [{
         ...
         * @param  {Number}        length 获取长度
         * @return {Delta Object}         当前内容，一个Delta对象
         */
 ...
 * @param  {string} protocols 协议
 * @return {boolean}          是否为标准url
 */
...
var Toolbar = function (_Module) {
    ...
    _createClass(Toolbar, [{
        ...
        /**
         * 为toolbar中控件添加click或change(select对象)事件并将控件加入controls数组
         * @param  {DOM Object} input - 单个控件的DOM对象
         * @return {Undefined} 无
         */
        ...
        value: function attach(input) {
            ...
            // 防止默认类型submit导致bug故添加type为button
...
/**
 * 在容器上添加button DOM元素
 * @param {DOM Element} container 容器
 * @param {String} format    format的类型比如image
 */
function addButton(container, format) {
...
/**
 * 创建并添加所有控件的html元素
 * @param {DOM Element} container 容器的dom元素对象
 * @param {Array}  groups    控件组
 */
function addControls(container, groups) {
    if (!Array.isArray(groups[0])) {
        groups = [groups];
    }
    // 为每组控件创建span元素并为每个控件添加button
